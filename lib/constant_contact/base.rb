		...
		class << self
			...
			def user_name
				if defined?(@user_name)
					@user_name
				elsif superclass != Object && superclass.user_name
					superclass.user_name.dup.freeze
				end
			end
			...
			def collection_path(prefix_options = {}, query_options = nil)
				...
				"/ws/customers/#{self.user_name}#{prefix(prefix_options)}#{collection_name}#{query_string(query_options)}"
			end
